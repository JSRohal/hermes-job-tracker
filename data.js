...
const MATCH_STOPWORDS = new Set([
  ...
  // additional generic JD/resume boilerplate that carries no skill signal on its own
  "join","looking","seeking","candidate","candidates","opportunity","opportunities","environment",
  "help","using","use","new","great","excellent","passionate","dynamic","innovative","world",
  "best","industry","leading","culture","values","mission","vision","committed","diverse",
  "diversity","inclusion","inclusive","employer","employment","apply","applicant","applicants",
  "responsibilities","duties","day","daily","basis","various","provide","provides","providing",
  "ensure","ensures","ensuring","support","supporting","perform","performs","performing","related",
  "level","based","within","without","home","office","site","full","time","part","status","seeks",
  "communication","collaboration","collaborative","teamwork","flexibility","adaptability",
  "initiative","motivated","detail","oriented","organized","organization","organizational",
]);

// Generic corporate/JD filler phrases that rank highly by frequency but
// carry no real skill signal — actively excluded from the keyword pool
// entirely (not just down-weighted), so they never show up as a "missing
// keyword" cluttering the analysis with noise.
const MATCH_FLUFF_PHRASES = new Set([
  "fast paced","fast-paced","team player","detail oriented","detail-oriented","self starter",
  "self-starter","wear multiple hats","wear many hats","get things done","think outside",
  "outside the box","roll up","up your sleeves","excellent communication","strong communication",
  "communication skills","interpersonal skills","work environment","fast paced environment",
  "growth mindset","go getter","go-getter","hit the ground","ground running","multiple projects",
  "attention to detail","results driven","results-driven","passionate about","make a difference",
  "dynamic environment","collaborative environment","positive attitude","can do attitude",
  "can-do attitude","strong work ethic","work ethic","cutting edge","cutting-edge",
  "state of the art","state-of-the-art","best in class","industry leading","industry-leading",
  "world class","world-class","equal opportunity","equal opportunity employer","protected veteran",
  "veteran status","without regard","sexual orientation","gender identity","national origin",
  "disability status","competitive salary","competitive compensation","fun environment",
  "great benefits","comprehensive benefits","benefits package","flexible schedule",
  "receive consideration","without regard to","qualified applicants","race color","color religion",
  "religion sex","all qualified","regardless of race","without regard","protected characteristic",
]);
