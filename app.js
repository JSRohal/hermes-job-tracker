...
// ------------------------------------------------------------------
function wireKanban() {
  // Nothing static to wire up front; columns/cards are (re)rendered and
  // (re)wired together each time the board is drawn, since drag targets
  // are regenerated with the data.
}
